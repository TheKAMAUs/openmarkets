...
use crate::{
    ...
    core::{
        ...
        message_handlers::channel_handlers::bitcoin_price::bitcoin_price_handler_bin,
    },
};
...
pub async fn handle_binary_message(
  ...
  Channel::Bitcoinprice => {  // ✅ Add this
                bitcoin_price_handler_bin(&data, state, client_id).await;
            }
