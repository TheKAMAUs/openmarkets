...
export default function ProfilePage() {
  ...
  function handleDepositFunds() {
    ...
    // Safety check (though button should be disabled for unverified users)
    if (!profileData.verified) {
      alert("Please verify your account before making a deposit.");
    ...
    const payload = {
      ...
      phone_number: "254707433711", // default phone number
      account_reference: "1234", // default account reference
    };

    // ---- Call the deposit API ----
    UserService.depositFunds(payload)
      .then((response) => {
        console.log("✅ Deposit response:", response);
        alert("Deposit request sent! Check your M-Pesa for the prompt.");
      })
      .catch((error) => {
  ...
  function handleWithdrawFunds() {
    ...
    const payload = {
      amount: 1, // default amount
      phoneNumber: "254708374149", // default phone
    };

    // ---- Call the withdrawal API ----
    UserService.withdrawFunds(payload)
      .then((response) => {
        console.log("✅ Withdrawal response:", response);
        alert("Withdrawal request sent! Check your phone for M-Pesa SMS.");
      })
      .catch((error) => {
          ...
          <Card.Root bg={cardBg} borderRadius="lg">
            <CardBody p={6}>
              <Stack
                ...
                justify="center"
              >
                <DepositButton defaultAmount={10} defaultPhone="254707433711" />
                ...
                <WithdrawButton defaultAmount={1} defaultPhone="254707433711" />
