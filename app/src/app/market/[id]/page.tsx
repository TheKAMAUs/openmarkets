...
import { MarketDescriptionBox } from "./_components/MarketDescriptionBox";
import DiscussionsClient from "./_components/DiscussionsClient";
  ...
  return (
    <Container my={10}>
      <Box mb={20}>
        ...
        <MarketDescriptionBox description={market.description} />
      ...
      {/* Discussions Section - Added here */}
      <Box mt={1}>
