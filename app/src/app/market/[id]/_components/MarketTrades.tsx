  ...
  return (
    <Box>
      <VStack gap={6} align="stretch">
        ...
        <Pagination.Root
          pageSize={Number(data.pageInfo?.pageSize || 10)}  // ✅ Convert to number
          page={Number(data.pageInfo?.page || 1)}           // ✅ Convert to number
          count={
            Number(data.pageInfo?.totalPages || 0) * Number(data.pageInfo?.pageSize || 0)
          }
        >
