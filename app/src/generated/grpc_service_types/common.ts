...
class PageInfo$Type extends MessageType<PageInfo> {
    constructor() {
        super("common.PageInfo", [
            ...
            { no: 3, name: "total_items", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 4, name: "total_pages", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 total_items */ 3:
                    message.totalItems = reader.uint64().toBigInt();
                    break;
