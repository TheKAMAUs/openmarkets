...
export interface Market {
    ...
    description: string;
    /**
     * @generated from protobuf field: repeated string logo = 4
     */
    logo: string[];
    /**
     ...
     * New fields
     *
     * @generated from protobuf field: string parent_id = 13
     */
    parentId: string;
    /**
     * @generated from protobuf field: bool is_event = 14
     */
    isEvent: boolean;
    /**
     * @generated from protobuf field: repeated markets.Market child_markets = 15
     */
    childMarkets: Market[];
    /**
     * @generated from protobuf field: string category = 16
     */
    category: string;
    /**
     * @generated from protobuf field: string resolution_criteria = 17
     */
    resolutionCriteria: string;
    /**
     * @generated from protobuf field: string slug = 18
     */
    slug: string;
}
/**
...
class MarketTrade$Type extends MessageType<MarketTrade> {
    constructor() {
        super("markets.MarketTrade", [
            ...
            { no: 3, name: "avatar", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
...
class Market$Type extends MessageType<Market> {
    constructor() {
        super("markets.Market", [
            ...
            { no: 4, name: "logo", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            ...
            { no: 14, name: "is_event", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 15, name: "child_markets", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Market },
            { no: 16, name: "category", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 17, name: "resolution_criteria", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
    ...
    create(value?: PartialMessage<Market>): Market {
        ...
        message.childMarkets = [];
        message.category = "";
        message.resolutionCriteria = "";
        message.slug = "";
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string description */ 3:
                    ...
                    break;
                case /* repeated string logo */ 4:
                    message.logo.push(reader.string());
                    break;
                ...
                case /* float no_price */ 12:
                    ...
                    break;
                case /* string parent_id */ 13:
                    message.parentId = reader.string();
                    break;
                case /* bool is_event */ 14:
                    message.isEvent = reader.bool();
                    break;
                case /* repeated markets.Market child_markets */ 15:
                    message.childMarkets.push(Market.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* string category */ 16:
                    message.category = reader.string();
                    break;
                case /* string resolution_criteria */ 17:
                    message.resolutionCriteria = reader.string();
                    break;
                case /* string slug */ 18:
    ...
    internalBinaryWrite(message: Market, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.logo.length; i++)
            writer.tag(4, WireType.LengthDelimited).string(message.logo[i]);
        ...
        /* string parent_id = 13; */
        if (message.parentId !== "")
            writer.tag(13, WireType.LengthDelimited).string(message.parentId);
        /* bool is_event = 14; */
        if (message.isEvent !== false)
            writer.tag(14, WireType.Varint).bool(message.isEvent);
        /* repeated markets.Market child_markets = 15; */
        for (let i = 0; i < message.childMarkets.length; i++)
            Market.internalBinaryWrite(message.childMarkets[i], writer.tag(15, WireType.LengthDelimited).fork(), options).join();
        /* string category = 16; */
        if (message.category !== "")
            writer.tag(16, WireType.LengthDelimited).string(message.category);
        /* string resolution_criteria = 17; */
        if (message.resolutionCriteria !== "")
            writer.tag(17, WireType.LengthDelimited).string(message.resolutionCriteria);
        /* string slug = 18; */
        if (message.slug !== "")
            writer.tag(18, WireType.LengthDelimited).string(message.slug);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
