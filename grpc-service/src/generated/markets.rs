...
pub struct Market {
    ...
    pub logo: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    ...
    /// New fields
    ///
    /// if this is a child, points to parent
    #[prost(string, tag = "13")]
    pub parent_id: ::prost::alloc::string::String,
    /// true if parent event
    #[prost(bool, tag = "14")]
    pub is_event: bool,
    /// children have same structure
    #[prost(message, repeated, tag = "15")]
    pub child_markets: ::prost::alloc::vec::Vec<Market>,
    #[prost(string, tag = "16")]
    pub category: ::prost::alloc::string::String,
    #[prost(string, tag = "17")]
    pub resolution_criteria: ::prost::alloc::string::String,
    /// URL-friendly name
    #[prost(string, tag = "18")]
