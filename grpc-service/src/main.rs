...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let price_service_layer = PriceServiceStub {
        state: state.clone(),
    };
    ...
    log_info!("🚀 gRPC-Web server running on http://{}", addr);
    log_info!("🔗 External clients should use https://your-render-url.onrender.com");
    ...
    Server::builder()
        ...
        .add_service(PriceServiceServer::new(price_service_layer))
        .serve(addr)
        .await?;
