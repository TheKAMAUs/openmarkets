...
-- for buy
-- For BUY: Sum the amount (quantity) as KES value (already in KES)
...
-- for sell check
-- Calculate shares from amount and price (amount / price)
SELECT SUM(quantity / price) FROM polymarket.orders
			WHERE user_id = 'def7d541-6c70-4571-abff-311574ce43ce'::uuid 
