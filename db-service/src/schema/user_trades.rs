...
pub async fn get_user_trades_paginated(
    ...
    log_info!("🔍 [START] Getting trades for user={}, page={}, page_size={}", user_id, page, page_size);
    ...
    log_info!("📦 Total trades: {}", total_count);
    ...
    log_info!("📋 Found {} trades for page {}", trades.len(), page);
