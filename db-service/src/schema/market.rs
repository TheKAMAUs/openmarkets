...
pub struct VolumeInfo {
    pub yes_buy_qty:   Option<Decimal>,
    pub yes_buy_usd:   Option<Decimal>,
    pub yes_sell_qty:  Option<Decimal>,
    pub yes_sell_usd:  Option<Decimal>,
    pub no_buy_qty:    Option<Decimal>,
    pub no_buy_usd:    Option<Decimal>,
    pub no_sell_qty:   Option<Decimal>,
    pub no_sell_usd:   Option<Decimal>,
}
...
pub async fn get_volume_info_by_market_id(
    pool: &PgPool,
    market_id: Uuid,
) -> Result<VolumeInfo, sqlx::Error> {
