...
pub struct UserHoldingWithMarket {
    ...
    pub market_logo: Vec<String>,  // Changed from String to Vec<String>
...
impl UserHoldings {
    ...
    log_info!("🔍 [START] Getting holdings for user={}, page={}, page_size={}", user_id, page, page_size);
    ...
    log_info!("📦 Total holdings: {}", total_count);
    
    // DATA query
    let data_start = Utc::now();
    log_info!("🔎 DATA query started at: {}", data_start.to_rfc3339());
    ...
    log_info!("📋 Found {} holdings for page {}", user_holdings.len(), page);
    log_info!("⏱️  BREAKDOWN: COUNT={}ms + DATA={}ms = TOTAL={}ms", 
        count_elapsed.num_milliseconds(),
        data_elapsed.num_milliseconds(),
